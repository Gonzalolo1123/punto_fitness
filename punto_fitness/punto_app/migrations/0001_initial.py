    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('establecimiento', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='punto_app.establecimiento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen', models.ImageField(blank=True, null=True, upload_to='membresias/')),
                ('establecimiento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='punto_app.establecimiento')),
            ],
            options={
                'db_table': 'membresia',
